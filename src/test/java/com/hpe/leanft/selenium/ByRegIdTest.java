...
public class ByRegIdTest {
    private By.ByRegId _byLocatorUnderTest;

    @Before
    public void setUp() throws Exception {
        _byLocatorUnderTest = new By.ByRegId(Pattern.compile("ab.*"), "ByRegId");
    }
    ...
    public void constructor_ShouldThrowExceptionInCaseOfNull() {
        _byLocatorUnderTest = new By.ByRegId(null, "");
    }

    @Test(expected = NullPointerException.class)
    public void constructor_ShouldThrowExceptionInCaseOfNullPattern() {
        _byLocatorUnderTest = new By.ByRegId(Pattern.compile(null), "");
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_ShouldThrowExceptionInCaseOfEmptyPattern() {
        _byLocatorUnderTest = new By.ByRegId(Pattern.compile(""), "");
    }
