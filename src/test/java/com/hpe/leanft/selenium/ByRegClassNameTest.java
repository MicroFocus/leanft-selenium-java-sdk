...
public class ByRegClassNameTest {
    private By.ByRegClassName _byLocatorUnderTest;

    @Before
    public void setUp() throws Exception {
        _byLocatorUnderTest = new By.ByRegClassName(Pattern.compile("ab.*"), "ByRegClassName");
    }
    ...
    public void constructor_ShouldThrowExceptionInCaseOfNull() {
        _byLocatorUnderTest = new By.ByRegClassName(null, "");
    }

    @Test(expected = NullPointerException.class)
    public void constructor_ShouldThrowExceptionInCaseOfNullPattern() {
        _byLocatorUnderTest = new By.ByRegClassName(Pattern.compile(null), "");
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_ShouldThrowExceptionInCaseOfEmptyPattern() {
        _byLocatorUnderTest = new By.ByRegClassName(Pattern.compile(""), "");
    }
