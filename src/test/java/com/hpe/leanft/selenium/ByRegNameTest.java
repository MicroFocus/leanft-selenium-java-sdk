...
public class ByRegNameTest {
    private By.ByRegName _byLocatorUnderTest;

    @Before
    public void setUp() throws Exception {
        _byLocatorUnderTest = new By.ByRegName(Pattern.compile("ab.*"), "ByRegName");
    }
    ...
    public void constructor_ShouldThrowExceptionInCaseOfNull() {
        _byLocatorUnderTest = new By.ByRegName(null, "ByRegName");
    }

    @Test(expected = NullPointerException.class)
    public void constructor_ShouldThrowExceptionInCaseOfNullPattern() {
        _byLocatorUnderTest = new By.ByRegName(Pattern.compile(null), "");
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_ShouldThrowExceptionInCaseOfEmptyPattern() {
        _byLocatorUnderTest = new By.ByRegName(Pattern.compile(""), "");
    }
