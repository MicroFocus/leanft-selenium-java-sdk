...
public class ByRegTagNameTest {
    private By.ByRegTagName _byLocatorUnderTest;

    @Before
    public void setUp() throws Exception {
        _byLocatorUnderTest = new By.ByRegTagName(Pattern.compile("ab.*"), "ByRegTagName");
    }
    ...
    public void constructor_ShouldThrowExceptionInCaseOfNull() {
        _byLocatorUnderTest = new By.ByRegTagName(null, "");
    }

    @Test(expected = NullPointerException.class)
    public void constructor_ShouldThrowExceptionInCaseOfNullPattern() {
        _byLocatorUnderTest = new By.ByRegTagName(Pattern.compile(null), "");
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_ShouldThrowExceptionInCaseOfEmptyPattern() {
        _byLocatorUnderTest = new By.ByRegTagName(Pattern.compile(""), "");
    }
